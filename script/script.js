...
document.getElementById('openChatButton').addEventListener('click', function() {
    ...
    var userResponses = {
    'Привет': 'Здравствуйте!',
    'Что ты умеешь?': 'Я могу помочь подобрать товар под ваши нужды и ответить на ваши вопросы',
    };
    ...
    // Создаем элемент для сообщения с указанием отправителя (пользователь/бот) и текстом сообщения
    ...
    'анекдот': 'Недавно прошёл дорогу в неположенном месте... И на меня сразу начали все наезжать...',
    'что ты умеешь?': 'Я могу отвечать на ваши вопросы и помочь с выбором товаров'
    };
